...
The codebase has been split into multiple modules to allow the api to be indpendent from implementation, and opening the possibility for ports to other platforms like Folia or Fabric in the future (not a guarantee).
